  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const auctionData = {
        ...
        estimatedPrice: parseFloat(formData.estimatedPrice as string),
        finalPrice: formData.finalPrice ? parseFloat(formData.finalPrice as string) : undefined,
        id: `auction-${Date.now()}`, // This would be generated by the backend
        slug: `${formData.make.toLowerCase()}-${formData.model.toLowerCase()}-${formData.year}`.replace(/\\s+/g, '-'),
        images: images.map(img => ({
          url: img.preview,
          name: img.name
        })),
        image: images.length > 0 ? images[0].preview : '/cars/placeholder.png' // Use first image as main image
      };
        ...
        <div className={styles.container}>
          <div className={styles.header}>
            <div className={styles.breadcrumbs}>
              ...
              <span className={styles.breadcrumbCurrent}>Add New Auction</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.formActions}>
              <Link href="/admin/vehicles/auction" className={styles.cancelButton}>
                Cancel
              </Link>
              <button 
                type="submit" 
