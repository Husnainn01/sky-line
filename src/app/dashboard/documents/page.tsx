...
export default function DocumentsPage() {
  return (
    <ComingSoon
      ...
      description="We're building a secure document management system for all your vehicle import paperwork. Soon you'll be able to access, download, and manage your shipping documents, customs forms, and vehicle certificates all in one place."
      icon={
