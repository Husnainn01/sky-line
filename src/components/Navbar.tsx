                ...
                <div className={styles.topBarContainer}>
                    <div className={styles.topBarLeft}>
                        <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className={styles.topBarLink}>
                            ...
                            <span>Tokyo, Japan - JDM Export Center</span>
                        </a>
                        <a href="tel:+81-3-1234-5678" className={styles.topBarLink}>
                            <svg className={styles.icon} viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className={styles.mainNavContainer}>
                    <Link href="/" className={styles.logo}>
                        ...
                        <div className={styles.logoTextContainer}>
                            <span className={styles.logoText}>JDM</span>
                            <span className={styles.logoAccent}>Global Auto Exports</span>
                        </div>
                    </Link>
